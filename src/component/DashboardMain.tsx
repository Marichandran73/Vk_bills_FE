...
const DashboardMain = () => {
  ...
  const stats = [
    ...
    },
    {
      label: "Customers",
      value: new Set(
        BillData.map((bill) => bill.customerDetails?.phone || bill.customerDetails?.customerName).filter(Boolean),
      ).size.toString(),
      icon: Users,
      change: "+5%",
      color: "green",
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 sm:h-20">
            ...
            <div className="flex items-center space-x-3">
              <div className="p-2 bg-gradient-to-br from-blue-600 to-blue-700 rounded-xl shadow-md shadow-blue-200">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400 hidden sm:block">Dashboard</p>
              </div>
            </div>
            ...
            <div className="hidden md:flex items-center space-x-3 lg:space-x-4">
              <button
                className="bg-gradient-to-r from-blue-600 to-blue-700 px-4 sm:px-5 py-2 sm:py-2.5 rounded-xl text-white font-medium hover:shadow-lg hover:shadow-blue-200 transition-all flex items-center gap-2 text-sm sm:text-base"
          ...
          {mobileMenuOpen && (
            <div className="md:hidden py-4 border-t border-slate-200 space-y-3">
              <button
                className="w-full bg-gradient-to-r from-blue-600 to-blue-700 px-4 py-2.5 rounded-xl text-white font-medium hover:shadow-lg hover:shadow-blue-200 transition-all flex items-center justify-center gap-2"
                onClick={() => {
                  setShowpopup(true);
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        ...
        <div className="mb-6 flex flex-wrap items-center gap-2 text-sm">
          <span className="text-slate-500 font-medium">Currently Billing As:</span>
              ...
              >
                <div className="flex items-center justify-between">
                  <div className={`p-2 ${colors.iconBg} rounded-lg`}>
                    <stat.icon className={`w-4 h-4 sm:w-5 sm:h-5 ${colors.text}`} />
                  </div>
                  <span
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 mb-8">
          <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-6 border border-blue-100">
            <div className="flex items-start justify-between">
              <div>
                <h3 className="text-sm font-medium text-blue-700 mb-1">Quick Actions</h3>
                <p className="text-xs text-blue-600/70">Manage your invoices efficiently</p>
              </div>
            ...
            <div className="flex flex-wrap gap-3 mt-4">
              <button
                ...
                className="bg-white px-4 py-2 rounded-lg text-sm font-medium text-slate-700 border border-slate-200 hover:border-blue-300 hover:shadow-sm transition-all flex items-center gap-2"
              >
          ...
          <div className="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-xl p-6 border border-emerald-100">
            <div className="flex items-start justify-between">
              <div>
                <h3 className="text-sm font-medium text-emerald-700 mb-1">Summary</h3>
                <p className="text-xs text-emerald-600/70">Your billing at a glance</p>
              </div>
            ...
            <div className="grid grid-cols-2 gap-4 mt-4">
              <div className="bg-white/70 rounded-lg p-3">
                ...
                <p className="text-lg font-bold text-slate-800">{BillData.length}</p>
              </div>
              <div className="bg-white/70 rounded-lg p-3">
                <p className="text-xs text-slate-500">Revenue</p>
                <p className="text-lg font-bold text-slate-800">₹{totalRevenue.toFixed(0)}</p>
              </div>
            </div>
          </div>
        </div>
