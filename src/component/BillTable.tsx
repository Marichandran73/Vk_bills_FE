...
const BillTable = ({ BillData }: { BillData?: any[] }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-indigo-50/30 p-4 md:p-6">
      ...
      <button
        onClick={() => navigate(-1)}
        className="mb-4 inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-indigo-600 hover:text-indigo-800 bg-white rounded-xl shadow-sm border cursor-pointer border-indigo-100 hover:shadow-md transition-all"
      >
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200/80 p-4 md:p-6 mb-6">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={RefreshData}
              className="p-2.5 rounded-xl outline-none cursor-pointer border border-gray-200 hover:border-indigo-300 hover:bg-indigo-50 transition-all text-gray-500 hover:text-indigo-600"
            >
                          ...
                          <td className="px-4 py-3">
                            {isFirstRow && (
                              <div className="flex items-center justify-center gap-1">
                                <button
                                  className="p-1.5 rounded-lg cursor-pointer text-gray-400 hover:text-indigo-600 hover:bg-indigo-50 transition-all"
                                  title="View"
                                ...
                                <button
                                  className="p-1.5 rounded-lg cursor-pointer text-gray-400 hover:text-blue-600 hover:bg-blue-50 transition-all"
                                  title="Print"
                                ...
                                <button
                                  className="p-1.5 rounded-lg cursor-pointer text-gray-400 hover:text-green-600 hover:bg-green-50 transition-all"
                                  title="Edit"
                                  onClick={() => {
